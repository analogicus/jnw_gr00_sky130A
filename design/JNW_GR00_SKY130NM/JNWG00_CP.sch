...
lab=KICK}
N 280 170 280 200 {}
C {JNW_ATR_SKY130NM/JNWATR_PCH_4C5F0.sym} 90 -170 0 0 {name=xb2 xoffset=0 yoffset=0 angle=0 M=1}
C {JNW_ATR_SKY130NM/JNWATR_PCH_4C5F0.sym} -20 -170 0 1 {name=xb1 xoffset=5 yoffset=0 angle=0 M=1}
C {JNW_ATR_SKY130NM/JNWATR_PCH_4C1F2.sym} 90 30 0 0 {name=xb3 xoffset=0 yoffset=0 angle=0 M=1}
C {JNW_ATR_SKY130NM/JNWATR_NCH_4C1F2.sym} 90 180 0 0 {name=xa3 xoffset=0 yoffset=0 angle=0 M=1}
C {JNW_ATR_SKY130NM/JNWATR_NCH_4C5F0.sym} 90 320 0 0 {name=xa2 xoffset=0 yoffset=0 angle=0 M=1}
C {JNW_ATR_SKY130NM/JNWATR_NCH_4C1F2.sym} -100 320 0 0 {name=xa1 xoffset=0 yoffset=0 angle=0 M=1}
...
C {JNW_ATR_SKY130NM/JNWATR_PCH_4C1F2.sym} 250 -100 0 0 {name=xb4 xoffset=0 yoffset=0 angle=0 M=1}
C {devices/ipin.sym} -200 -60 0 0 {name=p7 lab=PWRUP_1V8}
C {devices/opin.sym} 320 170 0 0 {name=p8 lab=LPFZ}
C {JNW_ATR_SKY130NM/JNWATR_NCH_4C1F2.sym} 240 230 0 0 {name=xa4 xoffset=0 yoffset=0 angle=0 M=10}
