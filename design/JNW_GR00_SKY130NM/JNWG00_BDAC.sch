...
S {}
E {}
T {Bipolar DAC} 770 -810 0 0 0.5 0.5 {}
N 230 -260 230 -200 {
lab=VSS}
N 190 -290 190 -200 {
lab=VSS}
...
C {sky130_fd_pr/pnp_05v5.sym} 400 -290 0 0 {name=Q2
model=pnp_05v5_W3p40L3p40
spiceprefix=X
}
C {sky130_fd_pr/pnp_05v5.sym} 580 -290 0 0 {name=Q3
model=pnp_05v5_W3p40L3p40
spiceprefix=X
}
C {sky130_fd_pr/pnp_05v5.sym} 750 -290 0 0 {name=Q4
model=pnp_05v5_W3p40L3p40
spiceprefix=X
}
C {sky130_fd_pr/pnp_05v5.sym} 920 -290 0 0 {name=Q5
model=pnp_05v5_W3p40L3p40
spiceprefix=X
}
C {sky130_fd_pr/pnp_05v5.sym} 1090 -290 0 0 {name=Q6
model=pnp_05v5_W3p40L3p40
spiceprefix=X
}
C {sky130_fd_pr/pnp_05v5.sym} 1260 -290 0 0 {name=Q7
model=pnp_05v5_W3p40L3p40
spiceprefix=X
}
C {sky130_fd_pr/pnp_05v5.sym} 1430 -290 0 0 {name=Q8
model=pnp_05v5_W3p40L3p40
spiceprefix=X
}
C {JNW_ATR_SKY130NM/JNWATR_NCH_4C1F2.sym} 190 -370 0 0 {name=x1 }
C {JNW_ATR_SKY130NM/JNWATR_NCH_4C1F2.sym} 380 -370 0 0 {name=x2 }
C {JNW_ATR_SKY130NM/JNWATR_NCH_4C1F2.sym} 560 -370 0 0 {name=x3 }
C {JNW_ATR_SKY130NM/JNWATR_NCH_4C1F2.sym} 730 -370 0 0 {name=x4 }
C {JNW_ATR_SKY130NM/JNWATR_NCH_4C1F2.sym} 900 -370 0 0 {name=x5 }
C {JNW_ATR_SKY130NM/JNWATR_NCH_4C1F2.sym} 1070 -370 0 0 {name=x6 }
...
C {devices/lab_wire.sym} 1210 -370 0 0 {name=p10 sig_type=std_logic lab=BD_1V8[1]}
C {devices/lab_wire.sym} 1380 -370 0 0 {name=p11 sig_type=std_logic lab=BD_1V8[0]}
