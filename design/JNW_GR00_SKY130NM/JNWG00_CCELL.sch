...
C {JNW_ATR_SKY130NM/JNWATR_NCH_2C1F2.sym} 670 -180 0 0 {name=x1 }
C {JNW_ATR_SKY130NM/JNWATR_NCH_2C1F2.sym} 670 -410 0 0 {name=x2 }
C {JNW_ATR_SKY130NM/JNWATR_PCH_2C1F2.sym} 930 -410 0 1 {name=x3 }
...
C {devices/lab_wire.sym} 630 -180 0 0 {name=p6 sig_type=std_logic lab=CA_1V8}
...
C {SUN_TR_SKY130NM/SUNTR_IVX1_CV.sym} 1440 -180 0 1 {name=x8 }
C {SUN_TR_SKY130NM/SUNTR_IVX1_CV.sym} 1340 -180 0 1 {name=x9 }
C {SUN_TR_SKY130NM/SUNTR_IVX1_CV.sym} 1240 -180 0 1 {name=x10 }
C {devices/lab_wire.sym} 1170 -140 0 0 {name=p16 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 1160 -220 0 0 {name=p17 sig_type=std_logic lab=VDD_1V8}
C {devices/lab_wire.sym} 1130 -180 0 0 {name=p18 sig_type=std_logic lab=CTN1_1V8}
C {JNW_ATR_SKY130NM/JNWATR_NCH_2C1F2.sym} 1180 -410 0 0 {name=x11 }
C {JNW_ATR_SKY130NM/JNWATR_PCH_2C1F2.sym} 1440 -410 0 1 {name=x12 }
C {devices/lab_wire.sym} 1370 -410 0 0 {name=p19 sig_type=std_logic lab=VDD_1V8}
C {devices/lab_wire.sym} 1250 -410 0 1 {name=p20 sig_type=std_logic lab=VSS}
C {devices/iopin.sym} 1310 -470 1 1 {name=p21 lab=CB}
C {devices/lab_wire.sym} 1500 -410 0 1 {name=p22 sig_type=std_logic lab=CTN1_1V8}
C {JNW_ATR_SKY130NM/JNWATR_NCH_2C1F2.sym} 910 -180 0 1 {name=x13 }
C {devices/lab_wire.sym} 950 -180 0 1 {name=p23 sig_type=std_logic lab=CB_1V8}
